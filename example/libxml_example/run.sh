...
if [ "$1" == "243" ] ; then
	rm *.part
	rm ./ddmin_243
	gcc ../../src/main.c ../../src/ddmin.c ../../src/range.c ./source/runner_libxml2_243.c -g -o ./ddmin_243 -lm -lpthread
	...
	rm *.part
	rm ./ddmin_350
	gcc ../../src/main.c ../../src/ddmin.c ../../src/range.c ./source/runner_libxml2_243.c -g -o ./ddmin_350 -lm -lpthread
